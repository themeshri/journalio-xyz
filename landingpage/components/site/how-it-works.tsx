...
const STEPS = [
  ...
  {
    icon: BookOpen,
    title: 'Trade your plan — we log every fill',
    body: 'Set a pre-session intent and trade. Journalio records every fill and lets you tag mistakes and grade each trade.',
  },
  {
    icon: LineChart,
    title: 'Find what’s costing you money',
    body: 'See your leaks ranked by dollars lost, your discipline score, and 50+ reports on what’s really working.',
  },
]
